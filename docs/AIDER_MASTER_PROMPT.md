...
| Ollama | 11434 | 15 models, primary: qwen2.5-coder:32b, agents use qwen2.5:14b |
...
```json
{
  ...
  "data": {
    ...
    "ai_models_used": ["qwen2.5:14b (local)", "qwen2.5-coder:32b (local)", "llava:13b (local)", "nomic-embed-text (local)"],
